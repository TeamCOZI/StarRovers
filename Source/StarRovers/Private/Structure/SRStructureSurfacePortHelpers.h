...
namespace StarRovers::Structure::SurfacePorts
{
		...
		FSRPlanetSurfaceGridCellId& OutConnectionCellId)
	{
		...
		const StarRovers::Surface::Interaction::FSRSurfaceGridDisplayMapper DisplayMapper(FaceResolution);
		const StarRovers::Surface::Interaction::FSRSurfaceGridDisplayCoord PortDisplayCoord =
			DisplayMapper.CanonicalToDisplay(PortCellId);
		StarRovers::Surface::Interaction::FSRSurfaceGridDisplayCoord ConnectionDisplayCoord;
